    ...
    <div className="space-y-6 pb-8 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Métricas operacionais, controle de dispensação e status de estoque do posto de saúde.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col gap-2">
          <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Itens em Estoque</span>
          <span className="text-3xl font-bold text-gray-900">1.240</span>
          <div className="text-xs text-cyan-600 font-medium flex items-center gap-1 mt-2">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col gap-2">
          ...
          <div className="w-full bg-gray-100 rounded-full h-2 mt-3">
            <div className="bg-cyan-600 h-2 rounded-full" style={{ width: '74%' }}></div>
          </div>
        </div>

        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col gap-2">
          <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Dispensações Hoje</span>
          <span className="text-3xl font-bold text-gray-900">42 receitas</span>
          <span className="text-xs text-gray-500 font-medium mt-2">Total de 1.450 unidades</span>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col gap-2">
          ...
          <div className="text-xs text-red-555 font-medium flex items-center gap-1 mt-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Giro de Estoque do Posto de Saúde</h3>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Categorias Dispensadas</h3>
          <div className="h-64 rounded-lg bg-gray-50 border border-dashed border-gray-200 flex items-center justify-center text-gray-400 font-medium">
